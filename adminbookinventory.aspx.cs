            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand(
                        "DELETE from book_master_tbl WHERE book_id='" + TextBox1.Text.Trim() + "'", con);
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tbl " +
                        "set book_name=@book_name,genre=@genre,author_name=@author_name,publisher_name=@publisher_name," +
