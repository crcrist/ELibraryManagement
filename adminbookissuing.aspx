               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6">
                        ...
                        <asp:Button ID="Button2" class="btn btn-block btn-primary btn-lg" runat="server" Text="Issue" />
                     </div>
                         </div>
                     <div class="col-6">
                         <div class="d-grid gap-2">
                        <asp:Button ID="Button4" class="btn btn-block btn-success btn-lg" runat="server" Text="Return" />
                             </div>
