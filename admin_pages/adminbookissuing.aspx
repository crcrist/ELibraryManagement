               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-6">
                        ...
                        <asp:Button ID="Button2" class="btn btn-block btn-primary btn-lg" runat="server" Text="Issue" OnClick="Button2_Click" />
                     </div>
                         </div>
                     <div class="col-6">
                         <div class="d-grid gap-2">
                        <asp:Button ID="Button4" class="btn btn-block btn-success btn-lg" runat="server" Text="Return" OnClick="Button4_Click" />
                             </div>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionStringBookInv %>" SelectCommand="SELECT * FROM [book_issue_tbl]"></asp:SqlDataSource>
                     <div class="col">
